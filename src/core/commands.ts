...
export const Cmd = {
  ...
  insertToggleList: "lotion.insertToggleList",
  insertToggleOl: "lotion.insertToggleOl",
  wrapListCollapsible: "lotion.wrapListCollapsible",
  ...
  insertH1: "lotion.insertH1",
  insertH2: "lotion.insertH2",
  insertH3: "lotion.insertH3",
  insertTodo: "lotion.insertTodo",
  insertDivider: "lotion.insertDivider",
  insertQuote: "lotion.insertQuote",
  ...
  searchWorkspaceCommands: "lotion.searchWorkspaceCommands",
