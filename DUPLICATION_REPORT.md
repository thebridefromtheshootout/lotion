...
- Lines 2-9 duplicate 8 lines with `src/blocks/selectBlock.ts` (lines 2-6), format: typescript
- Lines 15-18 duplicate 4 lines with `src/editor/focusMode.ts` (lines 151-155), format: typescript
- Lines 19-22 duplicate 4 lines with `src/editor/focusMode.ts` (lines 156-160), format: typescript
- Lines 25-30 duplicate 6 lines with `src/views/pageIcon.ts` (lines 18-31), format: typescript
- Lines 27-31 duplicate 5 lines with `src/editor/focusMode.ts` (lines 102-107), format: typescript
- Lines 83-89 duplicate 7 lines with `src/blocks/blockSwap.ts` (lines 43-49), format: typescript
- Lines 93-98 duplicate 6 lines with `src/blocks/blockSwap.ts` (lines 54-59), format: typescript
- Lines 106-110 duplicate 5 lines with `src/blocks/blockSwap.ts` (lines 68-71), format: typescript

### src/blocks/duplicateBlock.ts (7 matches)

- Lines 2-5 duplicate 4 lines with `src/blocks/selectBlock.ts` (lines 2-5), format: typescript
- Lines 18-24 duplicate 7 lines with `src/views/pageIcon.ts` (lines 18-31), format: typescript
- Lines 68-74 duplicate 7 lines with `src/blocks/moveBlock.ts` (lines 137-143), format: typescript
- Lines 77-84 duplicate 8 lines with `src/blocks/moveBlock.ts` (lines 146-153), format: typescript
- Lines 85-92 duplicate 8 lines with `src/blocks/moveBlock.ts` (lines 154-161), format: typescript
- Lines 96-99 duplicate 4 lines with `src/blocks/moveBlock.ts` (lines 165-168), format: typescript
- Lines 99-104 duplicate 6 lines with `src/blocks/moveBlock.ts` (lines 168-173), format: typescript
...
- Lines 111-115 duplicate 5 lines with `src/blocks/lockBlock.ts` (lines 84-88), format: typescript
- Lines 231-236 duplicate 6 lines with `src/blocks/lockBlock.ts` (lines 164-169), format: typescript
- Lines 371-377 duplicate 7 lines with `src/blocks/lockBlock.ts` (lines 363-369), format: typescript
- Lines 415-418 duplicate 4 lines with `src/blocks/lockBlock.ts` (lines 396-399), format: typescript
- Lines 453-458 duplicate 6 lines with `src/links/openLink.ts` (lines 36-40), format: typescript
- Lines 519-526 duplicate 8 lines with `src/links/openLink.ts` (lines 40-460), format: typescript
- Lines 543-555 duplicate 13 lines with `src/blocks/lockBlock.ts` (lines 485-496), format: typescript
- Lines 567-571 duplicate 5 lines with `src/blocks/lockBlock.ts` (lines 507-511), format: typescript
- Lines 583-588 duplicate 6 lines with `src/links/openLink.ts` (lines 36-40), format: typescript
- Lines 601-605 duplicate 5 lines with `src/media/carousel.ts` (lines 129-133), format: typescript
- Lines 648-655 duplicate 8 lines with `src/editor/comments/commentCommands.ts` (lines 42-632), format: typescript
- Lines 687-690 duplicate 4 lines with `src/blocks/lockBlock.ts` (lines 502-505), format: typescript
- Lines 688-694 duplicate 7 lines with `src/blocks/lockBlock.ts` (lines 506-571), format: typescript
...
- Lines 137-143 duplicate 7 lines with `src/blocks/duplicateBlock.ts` (lines 68-74), format: typescript
- Lines 146-153 duplicate 8 lines with `src/blocks/duplicateBlock.ts` (lines 77-84), format: typescript
- Lines 154-161 duplicate 8 lines with `src/blocks/duplicateBlock.ts` (lines 85-92), format: typescript
- Lines 154-158 duplicate 5 lines with `src/navigation/extractSubpage.ts` (lines 140-144), format: typescript
- Lines 165-168 duplicate 4 lines with `src/blocks/duplicateBlock.ts` (lines 96-99), format: typescript
- Lines 168-173 duplicate 6 lines with `src/blocks/duplicateBlock.ts` (lines 99-104), format: typescript
- Lines 246-252 duplicate 7 lines with `src/productivity/fireInto.ts` (lines 51-65), format: typescript

### src/blocks/selectBlock.ts (9 matches)

- Lines 2-6 duplicate 8 lines with `src/blocks/blockSwap.ts` (lines 2-9), format: typescript
- Lines 2-5 duplicate 4 lines with `src/blocks/duplicateBlock.ts` (lines 2-5), format: typescript
- Lines 12-17 duplicate 6 lines with `src/navigation/extractSubpage.ts` (lines 17-22), format: typescript
- Lines 40-46 duplicate 7 lines with `src/editor/focusMode.ts` (lines 150-156), format: typescript
- Lines 46-53 duplicate 8 lines with `src/editor/focusMode.ts` (lines 156-163), format: typescript
- Lines 86-97 duplicate 12 lines with `src/editor/focusMode.ts` (lines 165-176), format: typescript
- Lines 97-100 duplicate 4 lines with `src/editor/focusMode.ts` (lines 168-177), format: typescript
- Lines 108-116 duplicate 9 lines with `src/editor/focusMode.ts` (lines 191-199), format: typescript
- Lines 116-121 duplicate 6 lines with `src/editor/focusMode.ts` (lines 204-209), format: typescript
...
- Lines 153-159 duplicate 7 lines with `src/hostEditor/HostingEditor.ts` (lines 142-148), format: typescript
- Lines 164-170 duplicate 7 lines with `src/hostEditor/HostingEditor.ts` (lines 142-148), format: typescript
- Lines 179-184 duplicate 6 lines with `src/hostEditor/HostingEditor.ts` (lines 143-148), format: typescript
- Lines 191-197 duplicate 7 lines with `src/hostEditor/HostingEditor.ts` (lines 159-164), format: typescript
- Lines 202-212 duplicate 11 lines with `src/hostEditor/HostingEditor.ts` (lines 175-185), format: typescript
- Lines 218-224 duplicate 7 lines with `src/hostEditor/HostingEditor.ts` (lines 142-148), format: typescript
- Lines 230-238 duplicate 9 lines with `src/hostEditor/HostingEditor.ts` (lines 176-184), format: typescript
- Lines 246-254 duplicate 9 lines with `src/hostEditor/HostingEditor.ts` (lines 176-184), format: typescript
- Lines 271-276 duplicate 6 lines with `src/hostEditor/HostingEditor.ts` (lines 147-218), format: typescript
- Lines 310-315 duplicate 6 lines with `src/hostEditor/HostingEditor.ts` (lines 142-147), format: typescript
- Lines 426-431 duplicate 6 lines with `src/hostEditor/HostingEditor.ts` (lines 417-422), format: typescript
- Lines 444-449 duplicate 6 lines with `src/hostEditor/HostingEditor.ts` (lines 280-285), format: typescript
- Lines 453-458 duplicate 6 lines with `src/hostEditor/HostingEditor.ts` (lines 280-285), format: typescript
- Lines 471-476 duplicate 6 lines with `src/hostEditor/HostingEditor.ts` (lines 417-422), format: typescript
- Lines 480-485 duplicate 6 lines with `src/hostEditor/HostingEditor.ts` (lines 417-476), format: typescript
- Lines 498-503 duplicate 6 lines with `src/hostEditor/HostingEditor.ts` (lines 289-294), format: typescript
- Lines 507-512 duplicate 6 lines with `src/hostEditor/HostingEditor.ts` (lines 285-453), format: typescript
- Lines 516-521 duplicate 6 lines with `src/hostEditor/HostingEditor.ts` (lines 435-440), format: typescript
...
- Lines 2-8 duplicate 8 lines with `src/blocks/moveBlock.ts` (lines 1-8), format: typescript
- Lines 2-5 duplicate 4 lines with `src/core/simpleCommands.ts` (lines 4-7), format: typescript
- Lines 2-8 duplicate 7 lines with `src/links/linkInsert.ts` (lines 1-7), format: typescript
- Lines 2-11 duplicate 10 lines with `src/productivity/gitCommit.ts` (lines 1-9), format: typescript
- Lines 25-40 duplicate 6 lines with `src/core/slashCommands.ts` (lines 78-83), format: typescript
- Lines 32-40 duplicate 6 lines with `src/editor/copyCode.ts` (lines 20-25), format: typescript
- Lines 36-40 duplicate 6 lines with `src/blocks/lockBlock.ts` (lines 453-458), format: typescript
- Lines 36-40 duplicate 6 lines with `src/blocks/lockBlock.ts` (lines 583-588), format: typescript
- Lines 36-40 duplicate 6 lines with `src/blocks/moveBlock.ts` (lines 41-46), format: typescript
- Lines 36-40 duplicate 6 lines with `src/links/linkInsert.ts` (lines 24-29), format: typescript
- Lines 40-460 duplicate 8 lines with `src/blocks/lockBlock.ts` (lines 519-526), format: typescript
- Lines 40-45 duplicate 6 lines with `src/views/pageIcon.ts` (lines 31-36), format: typescript
- Lines 57-61 duplicate 5 lines with `src/links/searchLinks.ts` (lines 25-150), format: typescript
- Lines 62-67 duplicate 6 lines with `src/links/linkHover.ts` (lines 33-38), format: typescript
- Lines 127-135 duplicate 9 lines with `src/links/linkHover.ts` (lines 74-82), format: typescript
...
- Lines 4-7 duplicate 6 lines with `src/media/imageDrop.ts` (lines 3-8), format: typescript
- Lines 4-7 duplicate 4 lines with `src/navigation/turnInto.ts` (lines 3-6), format: typescript
- Lines 122-126 duplicate 5 lines with `src/links/searchLinks.ts` (lines 238-242), format: typescript
- Lines 142-154 duplicate 13 lines with `src/editor/emoji.ts` (lines 91-103), format: typescript
- Lines 142-148 duplicate 7 lines with `src/links/searchLinks.ts` (lines 250-256), format: typescript
- Lines 148-157 duplicate 10 lines with `src/links/searchLinks.ts` (lines 257-266), format: typescript
- Lines 169-179 duplicate 11 lines with `src/blocks/moveBlock.ts` (lines 42-52), format: typescript
- Lines 170-179 duplicate 10 lines with `src/navigation/extractSubpage.ts` (lines 50-59), format: typescript
- Lines 173-179 duplicate 7 lines with `src/navigation/turnInto.ts` (lines 289-295), format: typescript
- Lines 181-189 duplicate 9 lines with `src/media/resource.ts` (lines 41-49), format: typescript
- Lines 184-189 duplicate 5 lines with `src/media/graph.ts` (lines 80-84), format: typescript
- Lines 185-189 duplicate 5 lines with `src/media/image.ts` (lines 158-162), format: typescript
- Lines 185-189 duplicate 5 lines with `src/media/imageDrop.ts` (lines 58-62), format: typescript
...
- Lines 37-47 duplicate 11 lines with `src/views/wordCount.ts` (lines 34-44), format: typescript
- Lines 47-51 duplicate 5 lines with `src/navigation/renamePage.ts` (lines 14-46), format: typescript
- Lines 61-73 duplicate 14 lines with `src/__tests__/aesthetics.test.ts` (lines 52-65), format: typescript
...
- Lines 63-77 duplicate 15 lines with `src/navigation/renamePage.ts` (lines 46-64), format: typescript
- Lines 79-84 duplicate 6 lines with `src/navigation/page.ts` (lines 50-55), format: typescript
- Lines 85-89 duplicate 5 lines with `src/navigation/turnInto.ts` (lines 338-342), format: typescript
- Lines 140-144 duplicate 5 lines with `src/blocks/moveBlock.ts` (lines 154-158), format: typescript
...
- Lines 62-65 duplicate 4 lines with `src/views/wordCount.ts` (lines 23-26), format: typescript

### src/navigation/headingNav.ts (12 matches)

- Lines 2-7 duplicate 6 lines with `src/links/searchLinks.ts` (lines 4-9), format: typescript
- Lines 13-18 duplicate 6 lines with `src/editor/snippetExpander.ts` (lines 39-44), format: typescript
- Lines 13-18 duplicate 6 lines with `src/navigation/headingAnchor.ts` (lines 21-26), format: typescript
- Lines 13-17 duplicate 5 lines with `src/views/pageIcon.ts` (lines 31-36), format: typescript
- Lines 28-34 duplicate 7 lines with `src/navigation/headingNav.ts` (lines 20-27), format: typescript
- Lines 36-43 duplicate 8 lines with `src/views/pageIcon.ts` (lines 20-31), format: typescript
- Lines 43-50 duplicate 8 lines with `src/navigation/headingNav.ts` (lines 20-27), format: typescript
- Lines 51-59 duplicate 9 lines with `src/navigation/headingNav.ts` (lines 36-43), format: typescript
- Lines 60-66 duplicate 7 lines with `src/views/pageIcon.ts` (lines 18-31), format: typescript
- Lines 70-72 duplicate 4 lines with `src/navigation/headingAnchor.ts` (lines 26-29), format: typescript
- Lines 72-75 duplicate 4 lines with `src/editor/toc.ts` (lines 42-45), format: typescript
- Lines 99-103 duplicate 5 lines with `src/editor/comments/commentPanel.ts` (lines 103-107), format: typescript
...
- Lines 77-80 duplicate 4 lines with `src/navigation/pageRelink.ts` (lines 159-162), format: typescript
- Lines 81-93 duplicate 13 lines with `src/navigation/movePage.ts` (lines 67-79), format: typescript
- Lines 116-121 duplicate 6 lines with `src/navigation/renamePage.ts` (lines 133-141), format: typescript
- Lines 131-141 duplicate 11 lines with `src/navigation/renamePage.ts` (lines 28-37), format: typescript
- Lines 148-154 duplicate 7 lines with `src/navigation/renamePage.ts` (lines 46-51), format: typescript
- Lines 197-200 duplicate 4 lines with `src/navigation/renamePage.ts` (lines 102-105), format: typescript
...
- Lines 87-100 duplicate 14 lines with `src/navigation/quickSwitch.ts` (lines 33-69), format: typescript
...
- Lines 23-30 duplicate 8 lines with `src/navigation/turnInto.ts` (lines 179-288), format: typescript
- Lines 33-36 duplicate 4 lines with `src/navigation/renamePage.ts` (lines 64-67), format: typescript
- Lines 50-55 duplicate 6 lines with `src/navigation/extractSubpage.ts` (lines 79-84), format: typescript
- Lines 56-60 duplicate 5 lines with `src/navigation/turnInto.ts` (lines 338-342), format: typescript
...
- Lines 130-136 duplicate 7 lines with `src/navigation/tagIndex.ts` (lines 21-27), format: typescript
- Lines 159-162 duplicate 4 lines with `src/navigation/movePage.ts` (lines 77-80), format: typescript
- Lines 163-176 duplicate 14 lines with `src/navigation/pageRelink.ts` (lines 148-161), format: typescript
...
- Lines 39-46 duplicate 8 lines with `src/productivity/fireInto.ts` (lines 62-69), format: typescript

### src/navigation/recentPages.ts (4 matches)

- Lines 1-10 duplicate 10 lines with `src/navigation/wikiSearch.ts` (lines 1-11), format: typescript
- Lines 38-45 duplicate 8 lines with `src/navigation/recentPages.ts` (lines 29-35), format: typescript
- Lines 50-54 duplicate 5 lines with `src/productivity/fireInto.ts` (lines 10-14), format: typescript
- Lines 71-79 duplicate 9 lines with `src/productivity/bookmarks.ts` (lines 126-134), format: typescript
...
- Lines 46-64 duplicate 15 lines with `src/navigation/extractSubpage.ts` (lines 63-77), format: typescript
- Lines 46-51 duplicate 7 lines with `src/navigation/movePage.ts` (lines 148-154), format: typescript
- Lines 64-67 duplicate 4 lines with `src/media/image.ts` (lines 59-62), format: typescript
- Lines 64-67 duplicate 4 lines with `src/media/imageDrop.ts` (lines 41-44), format: typescript
- Lines 64-67 duplicate 4 lines with `src/navigation/page.ts` (lines 33-36), format: typescript
- Lines 102-105 duplicate 4 lines with `src/navigation/movePage.ts` (lines 197-200), format: typescript
- Lines 133-141 duplicate 6 lines with `src/navigation/movePage.ts` (lines 116-121), format: typescript
- Lines 135-140 duplicate 6 lines with `src/editor/comments/commentModel.ts` (lines 66-71), format: typescript
- Lines 142-152 duplicate 11 lines with `src/navigation/renamePage.ts` (lines 130-139), format: typescript
...
- Lines 21-27 duplicate 7 lines with `src/navigation/pageRelink.ts` (lines 130-136), format: typescript
- Lines 23-27 duplicate 5 lines with `src/navigation/wikiSearch.ts` (lines 43-48), format: typescript
- Lines 69-107 duplicate 8 lines with `src/links/linkInsert.ts` (lines 73-80), format: typescript
- Lines 108-114 duplicate 7 lines with `src/productivity/fireInto.ts` (lines 63-69), format: typescript

### src/navigation/turnInto.ts (18 matches)

- Lines 2-6 duplicate 5 lines with `src/productivity/bookmarks.ts` (lines 2-6), format: typescript
- Lines 3-6 duplicate 4 lines with `src/media/gif/gifCommand.ts` (lines 4-7), format: typescript
- Lines 8-14 duplicate 7 lines with `src/blocks/moveBlock.ts` (lines 7-13), format: typescript
- Lines 179-288 duplicate 8 lines with `src/media/resource.ts` (lines 22-29), format: typescript
- Lines 179-288 duplicate 8 lines with `src/navigation/page.ts` (lines 23-30), format: typescript
- Lines 219-225 duplicate 7 lines with `src/navigation/turnInto.ts` (lines 88-94), format: typescript
- Lines 226-234 duplicate 9 lines with `src/navigation/turnInto.ts` (lines 96-103), format: typescript
- Lines 235-238 duplicate 4 lines with `src/navigation/turnInto.ts` (lines 95-98), format: typescript
- Lines 236-243 duplicate 8 lines with `src/navigation/turnInto.ts` (lines 106-114), format: typescript
- Lines 255-259 duplicate 5 lines with `src/navigation/turnInto.ts` (lines 164-168), format: typescript
- Lines 260-267 duplicate 8 lines with `src/navigation/turnInto.ts` (lines 169-176), format: typescript
- Lines 289-295 duplicate 7 lines with `src/media/gif/gifCommand.ts` (lines 173-179), format: typescript
- Lines 297-322 duplicate 26 lines with `src/navigation/turnInto.ts` (lines 151-176), format: typescript
- Lines 338-342 duplicate 5 lines with `src/navigation/extractSubpage.ts` (lines 85-89), format: typescript
- Lines 338-342 duplicate 5 lines with `src/navigation/page.ts` (lines 56-60), format: typescript
- Lines 369-374 duplicate 6 lines with `src/navigation/turnInto.ts` (lines 180-185), format: typescript
- Lines 384-391 duplicate 8 lines with `src/navigation/turnInto.ts` (lines 86-92), format: typescript
- Lines 414-417 duplicate 4 lines with `src/navigation/turnInto.ts` (lines 288-291), format: typescript
...
- Lines 43-48 duplicate 5 lines with `src/navigation/tagIndex.ts` (lines 23-27), format: typescript
- Lines 66-68 duplicate 4 lines with `src/links/backlinks.ts` (lines 98-101), format: typescript
- Lines 93-98 duplicate 6 lines with `src/productivity/bookmarks.ts` (lines 126-131), format: typescript
- Lines 100-104 duplicate 5 lines with `src/editor/comments/commentPanel.ts` (lines 104-108), format: typescript

### src/productivity/bookmarks.ts (14 matches)

- Lines 2-8 duplicate 7 lines with `src/editor/dictate.ts` (lines 3-9), format: typescript
- Lines 2-11 duplicate 6 lines with `src/links/backlinks.ts` (lines 2-7), format: typescript
- Lines 2-7 duplicate 6 lines with `src/navigation/page.ts` (lines 2-7), format: typescript
- Lines 2-6 duplicate 5 lines with `src/navigation/renamePage.ts` (lines 1-5), format: typescript
- Lines 2-6 duplicate 5 lines with `src/navigation/turnInto.ts` (lines 2-6), format: typescript
- Lines 3-6 duplicate 4 lines with `src/productivity/dailyNote.ts` (lines 1-5), format: typescript
- Lines 34-44 duplicate 11 lines with `src/editor/comments/commentModel.ts` (lines 32-42), format: typescript
- Lines 49-53 duplicate 5 lines with `src/editor/comments/commentModel.ts` (lines 44-48), format: typescript
- Lines 111-114 duplicate 4 lines with `src/productivity/bookmarks.ts` (lines 84-87), format: typescript
- Lines 115-118 duplicate 4 lines with `src/productivity/bookmarks.ts` (lines 63-65), format: typescript
- Lines 119-122 duplicate 4 lines with `src/productivity/bookmarks.ts` (lines 91-94), format: typescript
- Lines 126-134 duplicate 9 lines with `src/navigation/recentPages.ts` (lines 71-79), format: typescript
- Lines 126-131 duplicate 6 lines with `src/navigation/wikiSearch.ts` (lines 93-98), format: typescript
- Lines 141-148 duplicate 8 lines with `src/views/outline.ts` (lines 60-67), format: typescript
...
- Lines 2-10 duplicate 10 lines with `src/editor/frontmatterEditor.ts` (lines 3-12), format: typescript
- Lines 2-10 duplicate 12 lines with `src/links/linkConvert.ts` (lines 2-13), format: typescript
- Lines 18-31 duplicate 6 lines with `src/blocks/blockSwap.ts` (lines 25-30), format: typescript
- Lines 18-31 duplicate 7 lines with `src/blocks/duplicateBlock.ts` (lines 18-24), format: typescript
- Lines 18-31 duplicate 8 lines with `src/formatting/wrapWith.ts` (lines 35-42), format: typescript
- Lines 18-31 duplicate 6 lines with `src/links/linkConvert.ts` (lines 19-24), format: typescript
- Lines 18-31 duplicate 7 lines with `src/navigation/headingNav.ts` (lines 60-66), format: typescript
- Lines 20-31 duplicate 8 lines with `src/navigation/headingNav.ts` (lines 36-43), format: typescript
- Lines 25-31 duplicate 7 lines with `src/lists/checkbox.ts` (lines 12-18), format: typescript
- Lines 30-31 duplicate 17 lines with `src/formatting/headingLevel.ts` (lines 39-55), format: typescript
- Lines 31-48 duplicate 7 lines with `src/editor/frontmatterEditor.ts` (lines 46-52), format: typescript
- Lines 31-35 duplicate 16 lines with `src/formatting/headingLevel.ts` (lines 14-29), format: typescript
- Lines 31-48 duplicate 8 lines with `src/links/linkConvert.ts` (lines 67-74), format: typescript
- Lines 31-36 duplicate 6 lines with `src/links/openLink.ts` (lines 40-45), format: typescript
- Lines 31-36 duplicate 6 lines with `src/lists/listToggle.ts` (lines 19-24), format: typescript
- Lines 31-36 duplicate 5 lines with `src/navigation/extractSubpage.ts` (lines 17-21), format: typescript
- Lines 31-36 duplicate 5 lines with `src/navigation/headingNav.ts` (lines 13-17), format: typescript
- Lines 31-36 duplicate 6 lines with `src/productivity/clipHistory.ts` (lines 32-37), format: typescript
- Lines 44-48 duplicate 4 lines with `src/links/linkConvert.ts` (lines 22-25), format: typescript
- Lines 121-126 duplicate 6 lines with `src/links/backlinkCodeLens.ts` (lines 174-179), format: typescript
