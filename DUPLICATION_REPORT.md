...
- [false alarm] Lines 41-45 duplicate 5 lines with `src/core/fileHashTracker.ts` (lines 35-41), format: typescript

### src/core/simpleCommands.ts (1 matches)

- [false alarm] Lines 4-7 duplicate 4 lines with `src/links/openLink.ts` (lines 2-5), format: typescript

### src/core/slashCommands.ts (1 matches)

- [false alarm] Lines 78-83 duplicate 6 lines with `src/links/openLink.ts` (lines 25-40), format: typescript

### src/core/structureLint.ts (1 matches)

- [false alarm] Lines 32-36 duplicate 5 lines with `src/editor/toc.ts` (lines 30-92), format: typescript

### src/core/trailingNewline.ts (3 matches)

- [false alarm] Lines 10-14 duplicate 5 lines with `src/formatting/smartTypography.ts` (lines 19-38), format: typescript
- [false alarm] Lines 11-14 duplicate 4 lines with `src/lists/listRenumber.ts` (lines 18-21), format: typescript
- [false alarm] Lines 19-22 duplicate 4 lines with `src/editor/footnote.ts` (lines 48-50), format: typescript

### src/core/webviewShell.ts (1 matches)

- [false alarm] Lines 35-43 duplicate 9 lines with `src/media/pdfExport.ts` (lines 143-153), format: typescript

### src/database/dbCodeLens.ts (3 matches)

- [false alarm] Lines 2-6 duplicate 5 lines with `src/links/linkHover.ts` (lines 2-6), format: typescript
- [false alarm] Lines 6-11 duplicate 6 lines with `src/media/graph.ts` (lines 8-12), format: typescript
- [false alarm] Lines 55-61 duplicate 7 lines with `src/database/dbCodeLens.ts` (lines 45-51), format: typescript
...
- [false alarm] Lines 255-259 duplicate 5 lines with `src/links/linkHover.ts` (lines 22-25), format: typescript
...
- [false alarm] Lines 1-14 duplicate 14 lines with `src/navigation/headingAnchor.ts` (lines 1-5), format: typescript
- [false alarm] Lines 18-46 duplicate 7 lines with `src/editor/editorDecorations.ts` (lines 99-105), format: typescript
- [false alarm] Lines 46-52 duplicate 7 lines with `src/navigation/headingAnchor.ts` (lines 18-21), format: typescript
- [false alarm] Lines 47-83 duplicate 8 lines with `src/editor/editorDecorations.ts` (lines 192-199), format: typescript
- [false alarm] Lines 53-58 duplicate 6 lines with `src/links/backlinkCodeLens.ts` (lines 103-107), format: typescript
- [false alarm] Lines 84-90 duplicate 7 lines with `src/views/readingProgress.ts` (lines 41-47), format: typescript
...
- [false alarm] Lines 14-29 duplicate 16 lines with `src/views/pageIcon.ts` (lines 31-35), format: typescript
- [false alarm] Lines 39-55 duplicate 17 lines with `src/views/pageIcon.ts` (lines 30-31), format: typescript

### src/formatting/smartPairs.ts (3 matches)

- [false alarm] Lines 33-38 duplicate 6 lines with `src/formatting/smartTypography.ts` (lines 18-23), format: typescript
- [false alarm] Lines 35-42 duplicate 8 lines with `src/formatting/smartTypography.ts` (lines 27-34), format: typescript
- [false alarm] Lines 45-49 duplicate 5 lines with `src/formatting/smartTypography.ts` (lines 106-149), format: typescript

### src/formatting/smartTypography.ts (9 matches)

- [false alarm] Lines 18-23 duplicate 6 lines with `src/formatting/smartPairs.ts` (lines 33-38), format: typescript
- [false alarm] Lines 19-38 duplicate 5 lines with `src/core/trailingNewline.ts` (lines 10-14), format: typescript
- [false alarm] Lines 27-34 duplicate 8 lines with `src/formatting/smartPairs.ts` (lines 35-42), format: typescript
- [false alarm] Lines 69-72 duplicate 4 lines with `src/editor/codeContext.ts` (lines 28-31), format: typescript
- [false alarm] Lines 104-110 duplicate 7 lines with `src/formatting/smartTypography.ts` (lines 78-84), format: typescript
- [false alarm] Lines 106-149 duplicate 5 lines with `src/formatting/smartPairs.ts` (lines 45-49), format: typescript
- [false alarm] Lines 124-132 duplicate 9 lines with `src/formatting/smartTypography.ts` (lines 74-111), format: typescript
- [false alarm] Lines 135-140 duplicate 6 lines with `src/formatting/smartTypography.ts` (lines 119-124), format: typescript
- [false alarm] Lines 180-183 duplicate 4 lines with `src/formatting/smartTypography.ts` (lines 98-101), format: typescript

### src/formatting/wrapWith.ts (1 matches)

- [false alarm] Lines 35-42 duplicate 8 lines with `src/views/pageIcon.ts` (lines 18-31), format: typescript
...
- [false alarm] Lines 4-13 duplicate 10 lines with `src/navigation/breadcrumb.ts` (lines 3-8), format: typescript
- [false alarm] Lines 38-47 duplicate 10 lines with `src/navigation/pageRelink.ts` (lines 26-35), format: typescript
- [false alarm] Lines 47-58 duplicate 12 lines with `src/navigation/movePage.ts` (lines 20-26), format: typescript
- [false alarm] Lines 90-93 duplicate 4 lines with `src/productivity/dailyNote.ts` (lines 11-14), format: typescript
- [false alarm] Lines 98-103 duplicate 6 lines with `src/navigation/wikiSearch.ts` (lines 41-46), format: typescript
- [false alarm] Lines 103-107 duplicate 6 lines with `src/formatting/headingColors.ts` (lines 53-58), format: typescript
- [false alarm] Lines 174-179 duplicate 6 lines with `src/views/pageIcon.ts` (lines 121-126), format: typescript

### src/links/backlinks.ts (4 matches)

- [false alarm] Lines 2-7 duplicate 6 lines with `src/productivity/bookmarks.ts` (lines 2-11), format: typescript
- [false alarm] Lines 68-97 duplicate 6 lines with `src/editor/editorDecorations.ts` (lines 118-123), format: typescript
- [false alarm] Lines 68-71 duplicate 4 lines with `src/productivity/fireInto.ts` (lines 11-14), format: typescript
- [false alarm] Lines 98-101 duplicate 4 lines with `src/navigation/wikiSearch.ts` (lines 66-68), format: typescript

### src/links/linkComplete.ts (3 matches)

- [false alarm] Lines 2-5 duplicate 4 lines with `src/links/linkHover.ts` (lines 2-5), format: typescript
- [false alarm] Lines 27-30 duplicate 4 lines with `src/productivity/fireInto.ts` (lines 8-10), format: typescript
- [false alarm] Lines 74-77 duplicate 4 lines with `src/productivity/fireInto.ts` (lines 65-67), format: typescript

### src/links/linkConvert.ts (4 matches)

- [false alarm] Lines 2-13 duplicate 12 lines with `src/views/pageIcon.ts` (lines 2-10), format: typescript
- [false alarm] Lines 19-24 duplicate 6 lines with `src/views/pageIcon.ts` (lines 18-31), format: typescript
- [false alarm] Lines 22-25 duplicate 4 lines with `src/views/pageIcon.ts` (lines 44-48), format: typescript
- [false alarm] Lines 67-74 duplicate 8 lines with `src/views/pageIcon.ts` (lines 31-48), format: typescript

### src/links/linkHover.ts (7 matches)

- [false alarm] Lines 2-6 duplicate 5 lines with `src/database/dbCodeLens.ts` (lines 2-6), format: typescript
- [false alarm] Lines 2-5 duplicate 4 lines with `src/links/linkComplete.ts` (lines 2-5), format: typescript
- [false alarm] Lines 3-14 duplicate 12 lines with `src/media/imageHover.ts` (lines 3-11), format: typescript
- [false alarm] Lines 22-25 duplicate 5 lines with `src/database/dbWebview.ts` (lines 255-259), format: typescript
- [false alarm] Lines 25-28 duplicate 4 lines with `src/media/imageHover.ts` (lines 21-25), format: typescript
- [false alarm] Lines 33-38 duplicate 6 lines with `src/links/openLink.ts` (lines 62-67), format: typescript
- [false alarm] Lines 74-82 duplicate 9 lines with `src/links/openLink.ts` (lines 127-135), format: typescript

### src/links/linkInsert.ts (5 matches)

- [false alarm] Lines 4-9 duplicate 6 lines with `src/media/pdfExport.ts` (lines 4-9), format: typescript
- [false alarm] Lines 24-29 duplicate 6 lines with `src/links/openLink.ts` (lines 36-40), format: typescript
- [false alarm] Lines 37-41 duplicate 5 lines with `src/productivity/fireInto.ts` (lines 11-16), format: typescript
- [false alarm] Lines 73-80 duplicate 8 lines with `src/navigation/tagIndex.ts` (lines 69-107), format: typescript

### src/links/linkValidator.ts (4 matches)

- [false alarm] Lines 3-8 duplicate 6 lines with `src/media/imageHover.ts` (lines 3-11), format: typescript
- [false alarm] Lines 31-36 duplicate 6 lines with `src/links/linkValidator.ts` (lines 26-31), format: typescript
- [false alarm] Lines 49-53 duplicate 5 lines with `src/navigation/tagIndex.ts` (lines 21-26), format: typescript
- [false alarm] Lines 73-76 duplicate 4 lines with `src/navigation/orphanPages.ts` (lines 37-38), format: typescript
...
- [false alarm] Lines 4-9 duplicate 6 lines with `src/navigation/headingNav.ts` (lines 2-7), format: typescript
- [false alarm] Lines 25-150 duplicate 5 lines with `src/links/openLink.ts` (lines 57-61), format: typescript
- [false alarm] Lines 150-153 duplicate 4 lines with `src/media/imageHover.ts` (lines 21-25), format: typescript
- [false alarm] Lines 238-242 duplicate 5 lines with `src/media/gif/gifCommand.ts` (lines 122-126), format: typescript
- [false alarm] Lines 250-256 duplicate 7 lines with `src/media/gif/gifCommand.ts` (lines 142-148), format: typescript
- [false alarm] Lines 257-266 duplicate 10 lines with `src/media/gif/gifCommand.ts` (lines 148-157), format: typescript
...
- [false alarm] Lines 13-18 duplicate 5 lines with `src/lists/listModel.ts` (lines 3-7), format: typescript
- [false alarm] Lines 13-18 duplicate 12 lines with `src/productivity/clipHistory.ts` (lines 1-12), format: typescript
- [false alarm] Lines 40-48 duplicate 10 lines with `src/__tests__/aesthetics.test.ts` (lines 11-20), format: typescript
- [false alarm] Lines 60-67 duplicate 8 lines with `src/productivity/bookmarks.ts` (lines 141-148), format: typescript
- [false alarm] Lines 143-147 duplicate 6 lines with `src/editor/focusMode.ts` (lines 179-184), format: typescript
- [false alarm] Lines 155-158 duplicate 4 lines with `src/editor/comments/commentPanel.ts` (lines 104-107), format: typescript
...
- [false alarm] Lines 41-47 duplicate 7 lines with `src/formatting/headingColors.ts` (lines 84-90), format: typescript

### src/views/wordCount.ts (11 matches)

- [false alarm] Lines 21-26 duplicate 6 lines with `src/productivity/taskProgress.ts` (lines 21-26), format: typescript
- [false alarm] Lines 23-26 duplicate 4 lines with `src/navigation/headingAnchor.ts` (lines 62-65), format: typescript
- [false alarm] Lines 23-26 duplicate 4 lines with `src/productivity/taskStrikethrough.ts` (lines 28-31), format: typescript
- [false alarm] Lines 26-34 duplicate 9 lines with `src/navigation/breadcrumb.ts` (lines 29-37), format: typescript
- [false alarm] Lines 26-34 duplicate 9 lines with `src/productivity/taskProgress.ts` (lines 26-34), format: typescript
- [false alarm] Lines 26-34 duplicate 9 lines with `src/productivity/taskStrikethrough.ts` (lines 31-39), format: typescript
- [false alarm] Lines 34-44 duplicate 11 lines with `src/navigation/breadcrumb.ts` (lines 37-47), format: typescript
- [false alarm] Lines 34-46 duplicate 12 lines with `src/productivity/taskProgress.ts` (lines 34-45), format: typescript
...
- [false alarm] Lines 16-23 duplicate 8 lines with `src/webview/communicators/DbPanelToExtensionCommunicator.ts` (lines 17-24), format: typescript

### src/webview/communicators/DbPanelToExtensionCommunicator.ts (1 matches)

- [false alarm] Lines 17-24 duplicate 8 lines with `src/webview/communicators/DatePanelToExtensionCommunicator.ts` (lines 16-23), format: typescript
...
- [false alarm] Lines 135-149 duplicate 17 lines with `src/webview/components/database/KanbanView.tsx` (lines 72-88), format: javascript
...
- [false alarm] Lines 72-88 duplicate 17 lines with `src/webview/components/database/calendarview/CalendarView.tsx` (lines 135-149), format: javascript
...
- [false alarm] Lines 107-112 duplicate 6 lines with `src/webview/components/database/tableview/TableView.tsx` (lines 67-72), format: tsx
...
- [false alarm] Lines 83-88 duplicate 6 lines with `src/webview/components/database/Toolbar.tsx` (lines 74-79), format: javascript
...
- [false alarm] Lines 155-159 duplicate 5 lines with `src/webview/components/FilterBar.tsx` (lines 55-59), format: tsx
